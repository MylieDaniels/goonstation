...
#define PROP_MOB_BRUTEMULT(x) x("brutemult", APPLY_ATOM_PROPERTY_PRODUCT, REMOVE_ATOM_PROPERTY_PRODUCT)
#define PROP_MOB_BURNMULT(x) x("burnmult", APPLY_ATOM_PROPERTY_PRODUCT, REMOVE_ATOM_PROPERTY_PRODUCT)
#define PROP_MOB_TOXMULT(x) x("toxmult", APPLY_ATOM_PROPERTY_PRODUCT, REMOVE_ATOM_PROPERTY_PRODUCT)
