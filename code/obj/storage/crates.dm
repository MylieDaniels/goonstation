...
/obj/storage/crate/stxcrate
	...
	desc = "A tightly sealed crate of deadly saxitoxin grenades."
	icon_state = "stxcrate"
	icon_opened = "stxcrateopen"
	...
	filled
		...
		New()
			...
			stx_filler.fill_remaining_with_instance(src, new /obj/randomloot_spawner/short/two_stx_grenades)
			..()
