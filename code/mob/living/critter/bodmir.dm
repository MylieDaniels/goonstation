...
/datum/ailment/parasite/bodmir_cable/stage_act(mob/living/affected_mob, datum/ailment_data/parasite/D, mult)
	...
	affected_mob.AddComponent(/datum/component/hallucination/random_sound, timeout=30, sound_list=src.common_halluc_sounds, sound_prob=(5 + 3 * D.stage))
	affected_mob.AddComponent(/datum/component/hallucination/random_sound, timeout=30, sound_list=src.rare_halluc_sounds, sound_prob=D.stage)
	...
	if(D.stage > 1)
		...
		if (probmult(D.stage ** 2))
			...
			affected_mob.HealDamage("All", 6, 4, 1)

/datum/ailment/parasite/bodmir_cable/on_infection(mob/living/affected_mob, datum/ailment_data/D)
	..()
