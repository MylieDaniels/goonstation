		...
		if(5)
			...
			if(probmult(40))
				var/list/possible_replacements = list("heart", "left_lung","right_lung","left_kidney","right_kidney",
					"liver","spleen","pancreas","stomach","intestines","appendix","butt", LIMB_LEFT_ARM, LIMB_RIGHT_ARM, LIMB_LEFT_LEG, LIMB_RIGHT_LEG)
				...
				for(var/i in 1 to 10)
					...
					else if (replacing_organ in list(LIMB_LEFT_ARM, LIMB_RIGHT_ARM, LIMB_LEFT_LEG, LIMB_RIGHT_LEG))
						var/obj/item/parts/robot_parts/O = H?.limbs.slot_filled(replacing_organ)
				...
				switch(replacing_organ)
					...
					if("butt") // lol butts
						...
						affected_mob.emote("scream")
					if(LIMB_RIGHT_LEG)
						H?.limbs.sever(LIMB_RIGHT_LEG)
						H?.limbs.replace_with(LIMB_RIGHT_LEG, /obj/item/parts/robot_parts/leg/right/standard, null , 0)
						boutput(affected_mob, SPAN_ALERT("Your right leg falls off as a robotic version grows in its place!"))
						affected_mob.emote("scream")
					if(LIMB_LEFT_LEG)
						H?.limbs.sever(LIMB_LEFT_LEG)
						H?.limbs.replace_with(LIMB_LEFT_LEG, /obj/item/parts/robot_parts/leg/left/standard, null , 0)
					...
					if(LIMB_RIGHT_ARM)
						...
						H?.limbs.replace_with(LIMB_RIGHT_ARM, /obj/item/parts/robot_parts/arm/right/standard, null , 0)
					...
					if(LIMB_LEFT_ARM)
						...
						H?.limbs.replace_with(LIMB_LEFT_ARM, /obj/item/parts/robot_parts/arm/left/standard, null , 0)
